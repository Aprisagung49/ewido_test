<x-users.layout>
    <x-users.panel>
        <x-users.section>
            ...
            {{-- KEADAAN KETIKA USER BERHASIL MENGIRIM DATA DIRI --}}
            @if (session('success'))
                                ...
                                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    <div class="sm:flex sm:items-start">
                                        ...
                                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                            <h3 class="text-base font-semibold text-gray-900" id="modal-title">Lamaran
                                                Anda Berhasil
                                                Dikirim
                                            </h3>
                                            <div class="mt-2">
        ...
        @foreach ($jobs as $job)
            <div class="mt-12 space-y-8 max-w-4xl mx-auto mb-14">
                <div class="mt-6 space-y-6">
                    ...
                    <x-slot:status_education></x-slot:status_education>
                    <x-slot:age></x-slot:age>
                    <x-slot:ipk></x-slot:ipk>

                    <x-slot:tag_job>

                    </x-slot:tag_job>
                    </x-users.job-card:jobSlug=>
        @endforeach
