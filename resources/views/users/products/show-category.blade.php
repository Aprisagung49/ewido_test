            ...
            <section class="px-10 py-8">
                ...
                <section class="container max-w-7xl mx-auto">
                    ...
                    @if ($products->count() > 0)
                        ...
                        <form action="{{ route('products.category', $group->name) }}" method="GET"
                            class="mb-6 flex gap-3">
                            <input type="text" name="q" value="{{ request('q') }}"
                                placeholder="Search Products..." class="w-full outline-none bg-white text-sm px-5 py-3" />
                            <button type="submit"
                    ...
                    @else
                        {{-- Ini artinya tidak ada produk sama sekali di kategori ini --}}

                        <body class="bg-gray-100 flex items-center justify-center min-h-screen">
                            <div class="text-center p-8 bg-white ">
                                <div class="mb-6">
                                    <div class="lg:mb-6 lg:flex lg:justify-center lg:items-center">
                                        <div class="lg:w-100 lg:h-60">
                                            <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve"
                                                id="website-maintenance" x="0" y="0"
                                                style="enable-background:new 0 0 1920 1080" version="1.1"
                                                ...
                                                <ellipse cx="914" cy="1005.2" rx="452.5" ry="36.6"
                                                    style="opacity:.1;fill:#2a94f4"></ellipse>
                                                <path
                                                    d="M776.8 888.5c0 8.5 6.9 15.4 15.4 15.4h553.3c8.5 0 15.4-6.9 15.4-15.4V412.1h-584v476.4z"
                                                    style="opacity:.19;fill:#ffbe55"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    style="opacity:.19;fill:#ffbe55"></path>
                                                <path d="m866.3 767.1.6-16.2 11.5 3.5 2.2 20.2s-11 .7-14.3-7.5z"
                                                    style="fill:#fcd2b1">
                                                </path>
                                                <path
                                                ...
                                                <path d="m814.5 767.1.6-16.2 11.5 3.5 2.2 20.2c-.1 0-11 .7-14.3-7.5z"
                                                    style="fill:#fcd2b1">
                                                </path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    style="fill:#0b4870"></path>
                                                <path d="m860.7 360-15.1 46.2 27.3 5.4 6-47.9z" style="fill:#fcd2b1">
                                                </path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    style="fill:#f7f7f7"></path>
                                                <path d="M867.2 529.7H905v3.2h-37.8z" style="opacity:.32;fill:#161616">
                                                </path>
                                                <path
                                ...
                                <p class="text-gray-600">
                                    ...
                                    Sorry for the inconvenience. We are currently performing maintenance. We will be
                                    back soon!
                                </p>
