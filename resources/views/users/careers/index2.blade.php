    ...
    <x-users.section>
        ...
        @if ($jobs->count() > 0)
            <div class="text-center mt-14">
                ...
                <p class="text-gray-500 mt-4">Placement will be adjusted based on the results of the test and interview.
                </p>
            </div>
            @foreach ($jobs as $job)
        ...
        @else
            <div class="text-center mt-14">
                ...
                <p class="text-gray-500 mt-4">We currently don’t have any open positions.
