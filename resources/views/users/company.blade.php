<x-users.layout>
    ...
    <section
        ...
        <nav
            class="flex-1 ml-4 overflow-x-auto whitespace-nowrap scrollbar-hide sm:overflow-x-visible md:overflow-x-visible lg:overflow-x-visible">
            <div class="flex space-x-4 sm:justify-between">
                <a href="#about" class="nav-link py-2 px-3 text-gray-700 font-semibold hover:text-gold">About
                    Us</a>
                <a href="#story" class="nav-link py-2 px-3 text-gray-700 font-semibold hover:text-gold">Our
                    Story</a>
    ...
    <x-users.panel color="gray" id="about">
        <x-users.section-about>
            ...
            <div class="text-sm mx-5 lg:text-base text-gray-700 leading-7 text-justify">
                <p class="mt-2">
                ...
                <ul role="list" class="mt-4 space-y-4 text-gray-600">
                    <li class="flex gap-x-3">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="mt-1 size-5 flex-none text-gold">
        ...
        <x-users.section>
            <div class="grid gap-4 mx-4 sm:grid-cols-12">
                <div class="col-span-12 sm:col-span-3">
                    <div
                        class="text-center sm:text-left lg:mb-14 before:block before:w-24 before:h-3 lg:before:mb-5 before:rounded-md before:mx-auto sm:before:mx-0 before:dark:bg-gold">
                ...
                <div class="relative col-span-12 space-y-6 sm:col-span-9">
                    <div
                        class="col-span-12 space-y-12 relative px-2 sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:dark:bg-gray-300">
                        <div
                            class="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:dark:bg-gold">
                            <h3 class="text-xl font-semibold tracking-wide lg:text-left text-center">
                                Foundation and Initial Growth
                            </h3>
                            <time
                                class="text-xs text-center lg:text-left tracking-wide uppercase dark:text-gray-600"><b>1974
                                    -
                                    1978</b></time>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
                                <div>
                                    <img class="h-[160px] lg:h-auto max-w-35 lg:max-w-40"
                                        src="storage/images/company-history/ewindo-1974.jpg" alt="">
                                </div>
                                <div>
                                    <img class="h-[160px] ml-6 lg:ml-0 md:ml-0 lg:h-auto max-w-35 lg:max-w-40"
                                        src="storage/images/company-history/ewindo-1975.jpg" alt="">
                                </div>
                                <div>
                                    <img class="h-[160px] lg:h-auto mt-4 lg:mt-0 md:mt-0 max-w-35 lg:max-w-40"
                                        src="storage/images/company-history/ewindo-1977.jpg" alt="">
                                </div>
                            </div>
                        </div>
                        <div
                            class="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:dark:bg-gold">
                            <h3 class="text-xl font-semibold tracking-wide text-center lg:text-left">
                                Expansion into Electric Cables and Certifications
                            </h3>
                            <time
                                class="text-xs tracking-wide uppercase lg:text-left dark:text-gray-600 text-center"><b>1986
                                    -
                                    1990</b></time>
                            <ul class="mt-3 mb-4 text-base text-gray-700 leading-7 text-justify">
                                <li>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
                                <div>
                                    <img class="h-[160px] lg:h-auto mt-4 max-w-35 lg:max-w-40"
                                        src="storage/images/company-history/ewindo-1986.jpg" alt="">
                                </div>
                                <div>
                                    <img class="h-[160px] ml-6 lg:ml-4 md:ml-4 lg:h-auto mt-4 max-w-35 lg:max-w-40"
                                        src="storage/images/company-history/ewindo-1991.jpg" alt="">
                                </div>
                            </div>
                        </div>
                        <div
                            ...
                            <time class="text-xs tracking-wide lg:text-left uppercase text-center dark:text-gray-600">
                                <b>1997 - 2001</b>
                            </time>
                            <ul class="mt-3 mb-4 text-base text-gray-700 leading-7 text-justify">
                                <li>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
                                <div>
                                    <img class="h-[160px] lg:h-auto mt-4 max-w-35 lg:max-w-40"
                                        src="storage/images/company-history/ewindo-1994.jpg" alt="">
                                </div>
                                <div>
                                    <img class="h-[160px] ml-6 lg:ml-3 md:ml-2 lg:h-auto mt-4 max-w-35 lg:max-w-40"
                                        src="storage/images/company-history/ewindo-1995.jpg" alt="">
                                </div>
                                <div>
                                    <img class="h-[160px] lg:h-auto mt-4 lg:ml-4 max-w-35 lg:max-w-40"
                                        src="storage/images/company-history/ewindo-1999.jpg" alt="">
                                </div>
                            </div>
                        </div>
                        <div
                            ...
                            <time
                                class="text-xs tracking-wide lg:text-left uppercase text-center dark:text-gray-600"><b>2002
                                    -
                                    2007</b></time>
                            <ul class="mt-3 mb-4 text-base text-gray-700 leading-7 text-justify">
                                <li>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
                                <div>
                                    <img class="h-[160px] lg:h-auto mt-4 max-w-35 lg:max-w-40"
                                        src="storage/images/company-history/ewindo-2000.jpg" alt="">
                                </div>
                                <div>
                                    <img class="h-[160px] ml-6 lg:h-auto md:ml-2 lg:ml-3 mt-4 max-w-35 lg:max-w-40"
                                        src="storage/images/company-history/ewindo-2003.jpg" alt="">
                                </div>
                                <div>
                                    <img class="h-[160px] lg:h-auto lg:ml-4 mt-4 max-w-35 lg:max-w-40"
                                        src="storage/images/company-history/ewindo-2006.jpg" alt="">
                                </div>
                            </div>
                        </div>
                        <div
                            ...
                            <time
                                class="text-xs tracking-wide lg:text-left uppercase text-center dark:text-gray-600"><b>2009
                                    -
                                    2014</b></time>
                            <ul class="mt-3 mb-4 text-base text-gray-700 leading-7 text-justify">
                                <li>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
                                <div>
                                    <img class="h-[160px] lg:h-auto mt-4 max-w-35 lg:max-w-40"
                                        src="storage/images/company-history/ewindo-2009.jpg" alt="">
                                </div>
                                <div>
                                    <img class="h-[160px] ml-6 lg:h-auto md:ml-2 lg:ml-3 mt-4 max-w-35 lg:max-w-40"
                                        src="storage/images/company-history/ewindo-2013.jpg" alt="">
                                </div>
                                <div>
                                    <img class="h-[80px] lg:h-auto mt-4 lg:ml-6 max-w-35 lg:max-w-40"
                                        src="storage/images/company-history/ewindo-2017.png" alt="">
                                </div>
                            </div>
                        </div>
                        <div
                            ...
                            <time
                                class="text-xs tracking-wide lg:text-left uppercase dark:text-gray-600 text-center"><b>2017
                                    -
                                    2020</b></time>
                            <ul class="mt-3 mb-4 text-base text-gray-700 leading-7 text-justify">
                                <li>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
                                <div>
                                    <img class="h-[140px] lg:h-auto mt-4 max-w-35 lg:max-w-40"
                                        src="storage/images/company-history/ewindo-2020.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <x-users.panel color="gray" id="quality">
        <x-users.section-about>
            ...
            <div class="text-base mx-5 text-gray-700 leading-7 text-justify">
                <p class="mt-8">
    ...
    <x-users.panel id="manpower">
        <x-users.section-about>
            ...
            <div class="mx-5 text-base text-gray-700 leading-7 text-justify">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        @php
                            $images = [
                                ...
                                'storage/images/sertifikat/Component---Power-Supply-Cords,-Cat.-No.-B-61/Component - Power Supply Cords, Cat. No. B-61_page-0001.jpg',
                                'storage/images/sertifikat/AWM-Single-&-Multi/AWM (Single & Multi)_page-0002.jpg',
                                'storage/images/sertifikat/AWM-Single-&-Multi/AWM (Single & Multi)_page-0004.jpg',
                                'storage/images/sertifikat/AWM-Single-&-Multi/AWM (Single & Multi)_page-0006.jpg',
                                'storage/images/sertifikat/AWM-Single/AWM (Single)_page-0001.jpg',
                                'storage/images/sertifikat/AWM-Multi/AWM (Multi)_page-0001.jpg',
                                'storage/images/sertifikat/ATL-AMF-E132202-702056001-Tambah-2576/ATL AMF E132202 702056001 (Tambah 2576)_page-0008.jpg',
                                'storage/images/sertifikat/ATL-AMF-E132202-702056001/ATL AMF E132202 702056001_page-0002.jpg',
                                'storage/images/sertifikat/ATL-AMF-E132202-702056001/ATL AMF E132202 702056001_page-0004.jpg',
                                'storage/images/sertifikat/ATL-AMF-E132202-702056001/ATL AMF E132202 702056001_page-0006.jpg',
                                'storage/images/sertifikat/56/Flexible-Cord-Types-SPT-1,-SPT-2,-SPT-3,-NISPT-1-&-NISPT-2/Flexible Cord (Types SPT-1, SPT-2, SPT-3, NISPT-1 & NISPT-2)_page-0001.jpg',
                                'storage/images/sertifikat/56/Flexible-Cord-Types-SVT,-SVTO,-SVTOO,-SJT,-SJTO,-SJTOO,-SJTW,-ST,-STO-&-STOO/Flexible Cord (Types SVT, SVTO, SVTOO, SJT, SJTO, SJTOO, SJTW, ST, STO & STOO)_page-0001.jpg',
                                'storage/images/sertifikat/34/PCS-00002.01-Tusuk-Kontak/PCS 00002.01 (Tusuk Kontak)_page-0001.jpg',
                                'storage/images/sertifikat/34/Sert-PCS-00002.02/Sert PCS 00002.02_page-0001.jpg',
                                'storage/images/sertifikat/12/Attachment-Plugs-7A---JET2448-43001-1001/Attachment Plugs 7A - JET2448-43001-1001_page-0001.jpg',
                                'storage/images/sertifikat/12/Attachment-Plugs-7A---JET2448-43001-1001/Attachment Plugs 7A - JET2448-43001-1001_page-0002.jpg',
                                'storage/images/sertifikat/12/Attachment-Plugs-7A---JET2448-43001-1001/Attachment Plugs 7A - JET2448-43001-1001_page-0003.jpg',
                                'storage/images/sertifikat/12/Attachment-Plugs-15A---JET2448-43001-1002/Attachment Plugs 15A - JET2448-43001-1002_page-0001.jpg',
                                'storage/images/sertifikat/12/Attachment-Plugs-15A---JET2448-43001-1002/Attachment Plugs 15A - JET2448-43001-1002_page-0002.jpg',
                                'storage/images/sertifikat/12/Attachment-Plugs-15A---JET2448-43001-1002/Attachment Plugs 15A - JET2448-43001-1002_page-0003.jpg',
                            ];
                        @endphp
    ...
    <x-users.panel id="quality-acc">
        <x-users.section>
            ...
            <div
                class="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-4 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 md:grid-cols-5 lg:mx-0 lg:max-w-none lg:grid-cols-5">

                @foreach (range(19, 28) as $i)
                    <img class="col-span-2 sm:col-span-2 md:col-span-1 lg:col-span-1 max-h-12 w-full object-contain"
                        src="{{ asset("storage/images/QA-EWINDO/$i.png") }}" alt="Logo {{ $i }}"
                        width="158" height="48" />
                @endforeach
            </div>
